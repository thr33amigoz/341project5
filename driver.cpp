...
int main() {
  ...
  // my own assignment operator test
  HashTable<Donut> test(10, cyclic_hash16);
  test = ht;
  cout << endl;

  test.getNext("sprinkle", d);
  test.getNext("sprinkle", d);
  
  cout << "assignment test dump:\n";
  test.dump();
  ...
  cout << endl;
  cout << "try to reinsert into emptied bucket:" << endl;
  vector<Donut> donuts2;
  
  donuts2.push_back(Donut("cinnamon", 3, "shack of donuts"));
  donuts2.push_back(Donut("cinnamon", 11, "shack of donuts"));
